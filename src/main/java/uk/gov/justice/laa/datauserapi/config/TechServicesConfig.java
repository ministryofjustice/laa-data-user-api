...
import uk.gov.justice.laa.datauserapi.client.ts.LiveTechServicesClient;
...
public class TechServicesConfig {
    ...
    public TechServicesClient liveTechServicesClient(ClientSecretCredential clientSecretCredential, RestClient restClient, ObjectMapper objectMapper,
                                                     CacheManager cacheManager, @Qualifier("tokenExpiryJwtDecoder") JwtDecoder jwtDecoder) {
        return new LiveTechServicesClient(clientSecretCredential, restClient, objectMapper, cacheManager, jwtDecoder);
    }
